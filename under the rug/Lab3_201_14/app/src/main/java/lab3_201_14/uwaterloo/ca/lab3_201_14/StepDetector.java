...
public class StepDetector {
    ...
    Timer stepMinTimer;
    Timer stepMaxTimer;
    private int stepMinTime = 300;
    private int stepMaxTime = 1750;
    ...
    public void startMinTimer() {
        ...
        stepMinTimer.schedule(stepMinTimerTask, stepMinTime);

    }

    public void startMaxTimer() {

        stepMaxTimer = new Timer();
        initializeMaxTimerTask();
        stepMaxTimer.schedule(stepMaxTimerTask, stepMaxTime);
