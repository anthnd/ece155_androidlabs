...
// MAGNETIC FIELD DISPLAY
        ...
        SensorEventListener magneticListener = new MagneticFieldSensorEventListener(magneticDisplay, graph);
...
//        final Button button2 = (Button) findViewById(R.id.clearDisplacementButton);
//        if (button != null)
...
//REAL ACCELEROMETER
        ...
        SensorEventListener realAccelerometerListener = new RealAccelerometerSensorEventListener(realAccelerometerDisplay);
        sensorManager.registerListener(realAccelerometerListener, realAccelerometerSensor, SensorManager.SENSOR_DELAY_FASTEST);


//        DisplacementManager displacementCalculator = new DisplacementManager(displacementVectorDisplay);


//MAPVIEW
//        MapView mv = new MapView(getApplicationContext(), 400, 400, 120, 120);
