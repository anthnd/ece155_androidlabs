...
public class MainActivity extends AppCompatActivity implements PositionListener
{
    ...
    public static PointF destination;
    ...
    public static void determineRoute(PointF orig, PointF dest)
    {
        ...
        if(MainActivity.map.calculateIntersections(orig, dest).size() == 0 && orig.x != 0 && dest.x != 0) {
            route.add(orig);
            route.add(dest);
        }
        MainActivity.mv.setUserPath(route);
    }
    ...
    public void originChanged(MapView source, PointF loc)
    {
        ...
        MainActivity.origin = loc;
        MainActivity.outputOrigin.setText(String.format("%.2f", MainActivity.origin.x) + " " + String.format("%.2f", MainActivity.origin.y));
        MainActivity.determineRoute(MainActivity.origin, MainActivity.destination);
        //outputOrigin.setText(String.valueOf(loc.x) + ", " + String.valueOf(loc.y));
    }
    ...
    public void destinationChanged(MapView source, PointF dest)
    {
        ...
        MainActivity.destination = dest;
        MainActivity.outputDestination.setText(String.format("%.2f", MainActivity.destination.x) + " " + String.format("%.2f", MainActivity.destination.y));
        MainActivity.determineRoute(MainActivity.origin, MainActivity.destination);
        //outputDestination.setText(String.valueOf(dest.x) + ", " + String.valueOf(dest.y));
    }
